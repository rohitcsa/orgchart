      ...
      <!--------------------------
       ...
       <div id="upload">
        <div class="col-lg-3 col-xs-12">
          <!-- small box -->
          <h2>STEP-1</h2>
          <h4>Choose database and table</h4>
          <div class="small-box bg-yellow">
            <div class="inner"style="height:400px">
            <form method=get action=createtable>
              <div class="form-group">
						<label for="email">Choose Your Database:</label> <select class="form-control" name="dbname">
						<option>specialchart</option>
						<option>inventory</option>
						<option>sales</option>
					<option>crosstab</option>
					<option>sakila</option>	
					<option>orgchart</option>	
						</select>
					</div><br/><br/><br/><br/><br/>
					  <div class="form-group">
						<label for="email">Table Nmae:</label> <input type="text"
							class="form-control" id="email" placeholder="Enter table name"
							name="tbname">
            ...
            <a href="#" class="small-box-footer">STEP-1 <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
         <div class="col-lg-3 col-xs-6">
          <!-- small box -->
           <h2>STEP-2</h2>
          <h4>Write Column</h4>
          <div class="small-box bg-maroon" style="color:black">
            <div class="inner">
           
					<div class="form-group">
						<label for="pwd">Column Names</label> <input type="text"
							class="form-control" id="pwd" placeholder="Col1"
							name="col1"><br>
							 <input type="text"
							class="form-control" id="pwd" placeholder="Col2"
							name="col2"><br>
							 <input type="text"
							class="form-control" id="pwd" placeholder="Col3"
							name="col3"><br>
							 <input type="text"
							class="form-control" id="pwd" placeholder="Col4"
							name="col4"><br>
							 <input type="text"
							class="form-control" id="pwd" placeholder="Col5"
							name="col5"><br>
							<input type="text"
							class="form-control" id="pwd" placeholder="Col6"
							name="col6"><br>
            ...
            <a href="#" class="small-box-footer">STEP-2 <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        </form>
         <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-black">
            <div class="inner">
              <div id="myModal">
				...
				<form action=uploadexcel method="get">
					<div class="form-group">
						<label for="email">Choose database</label>  <select class="form-control" name="dbnames" value="Choose Database">
						<option>specialchart</option>
						<option>inventory</option>
						<option>sales</option>
					<option>crosstab</option>
					...
					<div class="form-group">
						<label for="pwd">table name</label> <input type="text"
							class="form-control" id="pwd" placeholder="Enter table name"
							name="tbnames">
					</div>
					<div class="form-group">
						<label for="pwd">upload File:</label> <input type="file"
							class="form-control" id="pwd" placeholder="file name" name="file">
					</div>
            ...
            <a href="#" class="small-box-footer">STEP-3<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          ...
          <div class="small-box bg-black">
            <div class="inner">
              <div id="myModal">
				...
				<form action=dynamicjson method="get">
					<div class="form-group">
						<label for="email">Choose database</label>  <select class="form-control" name="dbname" value="Choose Database">
						<option>specialchart</option>
						<option>inventory</option>
						<option>sales</option>
					<option>crosstab</option>
					...
					<button type="submit" class="btn btn-success">Submit</button>
					<button type="button" class="btn btn-success" onclick="window.location.href='http://localhost:8000/0.1/dynamicjson?dbname=? & tbname=?">View Chart</button>
				</form>
