  ...
  <div class="content-wrapper">
	...
	<div id="dialog" title="Edit node">
			...
			<div id="dialog1" title="Edit node">
				<form method="get" action="addfinance">
					<h1>update the details</h1>
...
<script type="text/javascript">
		getOrgChart.themes.myCustomTheme = {
			...
			box : '<rect x="0" y="0" height="350" width="270" rx="10" ry="10" class="myCustomTheme-box" filter="url(#f1)"  />',
											...
											.addEventListener(
													...
													function() {
														...
														case "delete":
															...
															window.location.href = "deletefinance?id="
																	+ id + "";
															break;
														}
													});
