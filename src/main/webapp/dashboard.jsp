         ...
         <li><a href="finance.jsp"><i class="fa fa-link"></i> <span>Consulting</span></a></li>
          <li><a href="solution.jsp"><i class="fa fa-link"></i> <span>Solution</span></a></li>
           <li><a href="technology.jsp"><i class="fa fa-link"></i> <span>Technology</span></a></li>
               <li><a href="designs.jsp"><i class="fa fa-link"></i> <span>Designer Team</span></a></li>
        <li class="treeview">
      ...
      <div class="row">
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="technology.jsp" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="solution.jsp" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="finance.jsp" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
