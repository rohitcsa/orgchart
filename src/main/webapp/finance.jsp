...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header"style="height:50px">
      ...
      <ol class="breadcrumb">
        ...
        <li><span style="font-size: 40px; color: black;"
					...
					<li><input type=image onclick="printDiv('print')"
    ...
    <!-- Main content -->
    <section class="content container-fluid"id=print>
	...
	<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
        <div id='people' style="height:470px;width:100%"></div>
        
	<div id="dialog" title="Edit node">
				<form method="get" action="editfinance">
			...
			<div id="dialog1" title="Edit node">
				<form method="get" action="addfinance"name=test>
					<h1>Add the details</h1>
					
					<div>
				<label for="txtTitle"hidden>ID</label><br />
				<input id="id" type="text"name="id" hidden>
			</div>
			<div>
			<label for="txtTitle">Parent ID</label><br />
				<input id="pid" type="text"name="pid" readonly="readonly">
			</div>
...
<script type="text/javascript">
		getOrgChart.themes.myCustomTheme = {
			...
			box : '<rect x="0" y="0" height="150" width="270" rx="10" ry="10" class="myCustomTheme-box" filter="url(#f1)"  />',
														...
														case "delete":
														    ...
														    swal({
														      ...
														      confirmButtonColor: "#ec6c62"
														    	 ...
														    	 window.location.href =  "deletefinance?id="+ id;
														    });
															break;
														}
													});
...
<script
	...
	$('#save').click(function(){
		swal({
		      ...
		      confirmButtonColor: "#ec6c62"
		    	 ...
		    	 $('form[name=test]').setAttrib('action','addfinance');
	...
	<script>
		var makePdf = function () {
			...
			/*
			var source = window.document.getElementById( "basic-example" );
			pdf.fromHTML( source, 0, 0, {
				'width' : 1000
			} );
			 */
			html2pdf( window.document.getElementById( "orgchart" ), pdf, function ( pdf ) {
				pdf.output( 'dataurlnewwindow' ); //var div = document.createElement('pre');
			...
			/*
			 ...
			 canvg( c, document.getElementById( 'basic-example' ).outerHTML, {
			 ignoreMouse : true,
			 ignoreAnimation : true,
			 ignoreDimensions : true
			 } );
...
{ 
 ...
 <script src="styles/canvas2image.js"></script>
<script language="javascript">
window.takesScreenshot = function(){
	html2canvas($('#print'), {
		width : $('#print').find("").width(),
		height : $('#print').find("html").height(),
