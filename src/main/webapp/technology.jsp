...
<script src="getorgchart.js"></script>
	<script type="text/javascript">
		$.getJSON("jsonchart", function(source) {
			var peopleElement = document.getElementById("createchart");
			var orgChart = new getOrgChart(peopleElement, {
theme : "monica",
				primaryFields : [ "name", "email", "phone", "job", "id" ],
				color : "BLUE",
				linkType : "M",
				enableEdit : false,
	...
	<div id='createchart' style="height: 50%; font-size: 110px;"></div>
<script
